      ...
      <div className="w-96 max-w-screen-lg sm:w-[450px] mx-auto bg-white rounded-md custom-shadow">
        <div className="flex items-start justify-between bg-[#c5e6fc] rounded-t-md">
          <div className="w-1/2 p-3 lg:p-5">
            ...
            <p className="text-sm text-[#04CAFB]">Reset Password with MJRF</p>
          </div>
          <div className="w-1/2">
            <img
        ...
        <div className="px-3 md:px-5 py-6">
          <div className="mb-4 bg-[#c5e6fc] border-[1px] border-[#6bb93b75] text-center p-3 rounded-md">
            <p className="text-sm">
          ...
          <form onSubmit={handleReset}>
            ...
            <Button
              type="submit"
              className="float-right mb-6 py-3 mt-5 text-sm bg-[#04CAFB] hover:bg-green-700 transition-all duration-500"
            >
              Reset
            </Button>
          </form>
