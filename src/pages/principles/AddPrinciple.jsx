...
const AddPrinciple = ({ handleAddPrinciple }) => {
  ...
  const handleSubmit = (e) => {
    ...
    if (!image) {
      alert("Please upload an image for the client.");
      return;
    }
    ...
    localStorage.setItem(
      "principlesData",
      JSON.stringify([...existingPrinciples, newPrinciple])
    );

    handleAddPrinciple(newPrinciple);
    setName("");
    setImage(null);
  ...
  return (
    <>
      <div className="flex items-center gap-3 mb-3">
        <div>
          <h1 className="text-xl font-bold">Add Principle</h1>
          <p className="text-sm text-gray-500">
            You can add principle details from here.
          </p>
        </div>
      </div>
