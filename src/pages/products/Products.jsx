...
const Products = () => {
  ...
  return (
    <>
      <div className="w-full flex flex-col md:flex-row items-start md:items-center md:justify-between gap-5">
        ...
        <div className="w-full md:w-1/2 flex items-center md:justify-end gap-3">
          <div>
            <Link
              to="/categories"
              className="text-center w-full bg-[#04CAFB] text-white px-4 py-[11px] rounded-md me-2 mt-2 md:mt-0"
            >
              Add Category
            </Link>
            <Link
              to="/products/add-product"
              className="text-center w-full bg-[#04CAFB] text-white px-4 py-[11px] rounded-md mt-2 md:mt-0"
            >
              Add Product
            </Link>
          </div>
